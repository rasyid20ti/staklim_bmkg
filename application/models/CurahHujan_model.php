...
{
	public $table = 'rerata_ph';
	public $id = 'rerata_ph.id_pos';
	...
	public function get()
	{
		$this->db->select('ph.*, k.nama_kecamatan as kecamatan, kab.nama_kabupaten as kabupaten, k.nama_kecamatan, a.lintang as lintang, a.bujur as bujur');
	...
	{	
		$data = $this->db->query("SELECT * from rerata_ph WHERE nama_pos='$namapos';");
		return $data->result();
	}
	public function grafik()
	{	
		$this->db->select('ph.*,a.kecamatan as nama_kecamatan, a.kabupaten as nama_kabupaten');
		$this->db->from('rerata_ph ph');
		$this->db->join('alat a', 'ph.id_pos = a.nomor_pos');
