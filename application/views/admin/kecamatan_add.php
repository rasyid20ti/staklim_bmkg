				...
				<div class="card-body">
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<?= form_error('nama_kabupaten', '<small class="text-danger pl-3">', '</small>'); ?>
						</div>
						<div class="form-group">
							<label for="nama_kecamatan">Kecamatan</label>
							<input name="nama_kecamatan" type="text" class="form-control" id="nama_kecamatan" placeholder="Isi nama Kecamatan ">
							<?= form_error('nama_kecamatan', '<small class="text-danger pl-3">', '</small>'); ?>
						</div>
                        <a href="<?= base_url('admin/kecamatan') ?>" class="btn btn-danger">Tutup</a>
						<button type="submit"  href="<?= base_url('admin/kecamatan_add') ?>" name="tambah" class="btn btn-primary float-right">Simpan Kecamatan</button>
					</form>
				</div>
			</div>
