...
color: #000000;
			...
			<form method="POST" action="<?= base_url('admin/me48'); ?>" style="overflow: auto;">
			...
			<td rowspan="4">
			<a href="<?= base_url('admin/editme48/') . $us['id']; ?>" class="badge badge-warning">Edit</a>
