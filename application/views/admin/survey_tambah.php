    ...
    <div class="row justify-content-center">
        <div class="col-md-8 ">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/survey_submit') ?>" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="no_surat">Link Survei Terbaru</label>
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary float-right">Simpan Link Survei</button>
                    </form>
                </div>
            </div>
