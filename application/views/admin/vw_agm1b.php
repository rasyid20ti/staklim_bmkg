<div class="container-fluid">
	...
	<style type="text/css">
		...
		<form method="POST" action="<?= base_url('Admin/agm1b_edit'); ?>" style="overflow: auto;">
				...
				<tbody>
					...
					<?php foreach ($agm1b as $us) : ?>
						<tr>
							...
							<td><?= $us['Eva4']; ?></td>
							<td>
								<a href="<?= base_url('Admin/agm1b_edit/') . $us['id']; ?>" class="badge badge-warning">Edit</a>
								<a href="<?= base_url('Admin/agm1b_hapus/') . $us['id']; ?>" class="badge badge-danger">Hapus</a>
							</td>
						</tr>
						<?php $i++; ?>
					<?php endforeach; ?>
