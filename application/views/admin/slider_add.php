				...
				<div class="card-body">
					<form action="" method="POST" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input name="namaSlider" type="text" class="form-control" id="namaSlider" placeholder="Isi nama slider">
							<?= form_error('namaSlider', '<small class="text-danger pl-3">', '</small>'); ?>
						</div>
						<div class="form-group">
							<label for="fotoSlider">Link Foto Slider</label>
							<input name="fotoSlider" type="text" class="form-control" id="fotoSlider" placeholder="Isi link foto slider ">
