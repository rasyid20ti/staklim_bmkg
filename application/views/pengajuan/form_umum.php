...
<body>
					...
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a href="https://staklim-riau.bmkg.go.id/pengajuan/umum">
                            <div class="p-4" style="text-align:center;border: 4px solid #B0B0B0;border-radius: 10px;background: #FFFFFF;">
                                ...
                                <p style="color: #A6A6A6;font-size: 20px;font-weight: 700;">Umum</p>
                            </div>
                        </a>
					</div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <h4 align ="justify"> <strong><p style="color: #000000;font-size:18px;">Layanan ini adalah layanan berbayar sesuai dengan Peraturan Pemerintah No. 47 Tahun 2018. Ketentuan
                    tarif dapat dilihat di <a href="https://staklim-riau.bmkg.go.id/pengajuan/tarif">Menu Tarif PNBP</a>. Lakukan
                    pembayaran setelah mengisi form di <a href="https://staklim-riau.bmkg.go.id/home/bayar  ">Menu Pembayaran</a>.</p>
            <p style="color: #000000;font-size:18px;"> Jenis layanan yang dapat dilayani oleh Stasiun Klimatologi Riau :</p> 
                </strong></h4>
            <ol>
                <li>
                    <div align ="justify">Informasi Meteorologi dan Klimatologi.</div>
                </li>
                <li>
                    <div align ="justify">Jasa Konsultasi Meteorologi dan Klimatologi.</div>
                </li>
            </ol>    
            <h4 align ="justify"> <strong><p style="color: #000000;font-size:18px;"> Dengan persyaratan sebagai berikut :</p> 
                </strong></h4>
            <ol>
                <li>
                ...
                <li>
                    <div align ="justify">Melampirkan surat peromohonan yang ditandatangani oleh Pimpinan Perusahaan.</div>
                </li>
                <li>
                    <div align ="justify">Membayar tarif Penerimaan Negara Bukan Pajak (PNBP).</div>
                </li>
            </ol>
            <div class="card-body">
                <form action="<?= base_url('Umum/tambah_umum') ?>" method="POST" enctype="multipart/form-data">
                    <!-- <div class="form-group">
                            <label for="survey">Isi Survey berikut <a href="https://bit.ly/survei_sem1">https://bit.ly/survei_sem1</a> sebelum mengisi
                                Form Pengajuan Data dan Informasi. Screenshoot hasil Survey dan input ke form berikut ini.
                            </label>
                            <input type="text" name="survey" value="<?= set_value('survey'); ?>" class="form-control form-control-user" id="survey" placeholder="Input Screenshoot Survey disini">
                        </div> -->
						<div class="form-group">
							<label for="survey"> Isi <a href="https://bit.ly/survei_sem1">survey kepuasan masyarakat</a> sebelum mengisi <b>Form</b> dibawah ini, lalu unggah bukti <i>screenshoot</i> jika sudah selesai mengisi survey.
							</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="universitas">Nama Perusahaan/Instansi</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="peruntukan_data" value="<?= set_value('peruntukan_data'); ?>" class="form-control form-control-user" id="peruntukan_data" placeholder="Cth. untuk survey proyek">
                        </div>
                    ...
                    <div class="form-group">
                        <label for="surat_permohonan">Surat Permohonan Ditandatangani Oleh Pimpinan Perusahaan
                        </label>
                        <div class="custom-file">
                    ...
                    <div class="form-group">
                        ...
                        <select name="periode" value="<?= set_value('periode'); ?>" id="periode" class="form-control">
                    ...
                    <div class="form-group">
                        <label for="panjang_data">Panjang Data (cth. 1 Agustus 2020 - 30 September 2020)</label>
                        <input type="text" name="panjang" value="<?= set_value('panjang'); ?>" class="form-control form-control-user" id="panjang" placeholder="Panjang Data (cth. 1 Agustus 2020 - 30 September 2020)">
                    </div>
