...
<head>
	<meta charset="utf-8">
	<title>BMKG | Stasiun Meteorologi Riau</title>
	...
	<linkq href="https://fonts.googleapis.com/css2?family=Heebo:wght@400;500;600&family=Nunito:wght@600;700;800&family=Pacifico&display=swap" rel="stylesheet">
		...
		<script type="text/javascript">
			function checkAll(ele) {
				var checkboxes = document.getElementsByName('unsur[]');
				if (ele.checked) {
...
<header>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-light px-4 px-lg-5 py-3 py-lg-0"></nav>
	<div class="position-relative p-0">
		<nav class="navbar navbar-dark navbar-expand-lg bg-light px-4 px-lg-5 py-3 py-lg-0">
			<a href="http://staklim-riau.bmkg.go.id/" class="navbar-brand p-0">
				<img src="<?= base_url('assets2/img/logo_staklimRiau_putih.png'); ?>" alt="Logo">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav ms-auto py-0 pe-4 font-header">
					<a href="<?php echo site_url('home/'); ?>" class="nav-item nav-link active">Beranda</a>
