...
<body>
	...
	<div class="teks-besar p">
			...
			<?php foreach ($infografis as $i) : ?>
				<h3>Normal Arah dan Kecepatan Angin</h3>
				<div style="color: #616161;margin-bottom: 10px;"><i class="fas fa-calendar mr-1"></i> <?= date('d M Y', strtotime($i['created_at'])); ?> &nbsp; <i class="fa fa-list-alt" aria-hidden="true"></i> <?= $i['namaMenu'] ?></div>
        <?php endforeach; ?>
        <div style="margin-top:50px;"></div>
        <?php foreach ($angin as $a) : ?>
          <center><h4><?= $a['judul']; ?></h4></center>
        <div class="row g-4" style="margin-top:10px;">
					<div class="col-md-6">
						<div class='colSamping'>
							<img id="myImg" src="<?= $a['gambar2']; ?>" style="width:100%">
						</div>
					</div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-6">
                      <label>Topik</label>  
                      <p><i class="fas fa-book"></i>  <?= $i['namaMenu']; ?></p>
                    </div>
                    <div class="col-lg-6">
